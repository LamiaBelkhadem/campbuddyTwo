...
export default function SidebarCampsite() {
    ...
    const activeCampsiteDetails = campsites.find(campsite => campsite._id === activeOption);
    ...
    return (
        <div className="sidebar-campsite-page">
                ...
                <nav id="sidebar">
                    ...
                    <ul className="list-unstyled components">
                        {campsites.map((campsite) => (
                            <li
                                key={campsite._id}
                                className={`campsite-option ${activeOption === campsite._id ? 'active' : ''}`}
                                onClick={() => handleOptionClick(campsite._id)}
                            >
                                <div className="option-img-wrapper">
                                    <img src={PF + campsite.mainImg} alt={campsite.name} className="option-img"/>
                                </div>
            ...
            {activeCampsiteDetails && <CampsiteDetails details={activeCampsiteDetails} />}
        </div>
    );
}
