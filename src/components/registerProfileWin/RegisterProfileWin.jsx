            ...
            <div className="profile-box">
                <form onSubmit={profileHandler}>
                    ...
                    <div className="profile-pic-container" onClick={() => document.getElementById('profile-pic-input').click()}>
                        <img className="profile-pic" src={selectedImage ? selectedImage : "/assets/defaultpp.jpg"} alt=""/>
                        <input type="file" id="profile-pic-input" style={{display: 'none'}} onChange={handleImageChange} />
                        <div className="overlay-text">Add a photo</div>
                    </div>
                    <div className="username1"></div>
                    <div className="desc">Share information about you so that fellow campers can get to know you!
                    </div>
                    <div className="input-icon">
                        <Person className="icon"/>
                        <input className="input-box"  type="text" placeholder="Bio" ref={bio}/>
                    </div>
                    <div className="box1">
                        <div className="input-icon">
                            <Person className="icon"/>
                            <input className="input-box" type="age" placeholder="Age" ref={age}/>
                        </div>
                    ...
                    <div className="input-icon">
                        ...
                        <input className="input-box" minLength="8" type="text" ref={Area}
                               placeholder="Where do you live?"/>
                    </div>
                    <div className="input-icon">
                        <Person className="icon"/>
                        <input className="input-box"  type="text" ref={interests} placeholder="Interests"/>
                    </div>
                    <div className="input-icon">
                    ...
                    ></textarea>
                        <p style={{color: text.length >= 500 ? 'red' : 'black'}}>{text.length}/500</p>
                    </div>
                    <button className="update-btn" type="submit">Create Profile</button>
                </form>
