	...
	return (
		...
		<div className="account-details" style={{ textDecoration: "none !important" }}>
			<Link to={`/app/lobby/created/${user._id}`} className="create-btn-container"
				...
				<Button
					sx={{ width: 290, height: 60, ml: 2, mb: 2, mt: -1, backgroundColor: "#ff6a85", color: "white" }}
			...
			<Link to={"/app/lobby/create"} className="create-btn-container"
				  style={{ textDecoration: "none !important" }}>
				<Button style={{ textDecoration: "none !important" }} sx={{
					width: 290,
					height: 60,
					ml: 2,
					mb: 3,
				...
				}} variant="outlined" startIcon={<AddIcon sx={{ color: "white !important" }} />}>
					Create a Lobby
				</Button>
			</Link>
