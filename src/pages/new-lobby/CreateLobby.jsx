...
const equipmentList = ["Tent", "Utensils", "Sleeping Bag", "Camp Stove", "First Aid Kit", "Flashlight", "Portable Charger", "Maps and Compass", "Water Bottle", "Fire Starter",];
...
const createLobbySchema = Yup.object().shape({
    ...
    maximumParticipants: Yup.number().required("Maximum number of participants is required"),
...
export default function CreateLobby() {
    ...
    return (<div className="create-lobby-page">
            <Navbar/>
            <div className="create-lobby-container">
                <div className="create-lobby-box">
                    <Formik initialValues={initialValues} onSubmit={handleSubmit} validationSchema={createLobbySchema}>
                            ...
                            <Form style={{
                                ...
                                <Stack>
                                    ...
                                    <Stack direction={"row"} sx={{
                                        width: "100%", justifyContent: "space-between", columnGap: "10px"
                                    }}>
                                        <Box sx={{flex: 1}}>
                                ...
                                <InputLabel htmlFor={"campsite"}>Number of participants</InputLabel>
                                <Field
                                    InputProps={{
                                ...
                                <Field as={Select}
                                       sx={{height: 40}}
                                       InputProps={{startAdornment: <LocationOnIcon className="icon"/>}}
                                ...
                                >
                                    ...
                                    {campsites?.map((campsite) => (<MenuItem key={campsite.id} value={campsite.id}>
                                        {campsite.name}
                                    </MenuItem>))}
                                </Field>
                                ...
                                <Box sx={{width: "100%", height: "30px"}}/>
                                <Box sx={{width: "100%"}}>
                                    <InputLabel htmlFor={"experience"}>Select required experience</InputLabel>
                                    <Field
                                        sx={{height: 40, width: "100%"}}
                                        InputProps={{
                                            startAdornment: <AdjustIcon className="icon"/>
                                ...
                                <div className="input-lobby-icon">
                                    ...
                                    <div className="input-lobby-box-radio">
                                        ...
                                        <Field
                                            ...
                                            name="gender"
                                        >
                                            <FormControlLabel control={<Radio/>} value={"Male-Only"}
                                                              label={"Male only"}/>
                                            <FormControlLabel id="female-only" control={<Radio/>} value="Female-Only"
                                                              label={"Female only"}/>
                                            <FormControlLabel id="all" control={<Radio/>} value='All' label={"All"}/>
                                        </Field>
                                    </div>
                                </div>
                                ...
                                <Box sx={{width: "100%"}} alignContent={"flex-start"}>
                                    <InputLabel htmlFor={"ambiance"} textAlign={"left"}>Select Ambiance</InputLabel>
                                    <Field
                                        InputProps={{
                                            startAdornment: <AdjustIcon className="icon"/>
                                        }}
                                        ...
                                        <MenuItem value="nature-immersive">Nature-Immersive</MenuItem>
                                ...
                                <div className="input-lobby-icon">
                                    ...
                                    <div className="input-lobby-box-radio">
                                        ...
                                        <Field
                                            ...
                                            name="food"
                                        >
                                            <FormControlLabel control={<Radio/>} label={"Required"} value={true}/>
                                            <FormControlLabel control={<Radio/>} label={"Provided"} value={false}/>
                                        </Field>
                                    </div>
                                </div>
                                ...
                                <div className="input-lobby-icon">
                                    ...
                                    <div className="input-lobby-box-radio">
                                        ...
                                        <Field
                                            ...
                                            name="transport"
                                        >
                                            <FormControlLabel control={<Radio/>} label={"Not provided"}
                                                              value={false}/>
                                            <FormControlLabel control={<Radio/>} label={"Provided"} value={true}/>
                                        </Field>
                                    </div>
                                </div>

                                <Stack className="equipments"
                                       sx={{width: "100%", columnGap: 20,}} direction={"row"}>
                                    <FormControl sx={{m: 1, width: "100%"}}>
                                        <InputLabel id="equipment-needed">Equipment needed</InputLabel>
                                        <Field
                                            as={Select}
                                            id="equipment-needed"
                                            multiple
                                        ...
                                        >
                                            {equipmentList.map((name) => (
                                                <MenuItem key={name} value={name}>
                                                    <Checkbox checked={values.equipmentNeeded.indexOf(name) > -1}/>
                                    ...
                                    <FormControl sx={{m: 1, width: "100%"}}>
                                        <InputLabel id="equipment-provided">Equipment provided</InputLabel>
                                        <Field
                                            as={Select}
                                        ...
                                        >
                                            {equipmentList.map((name) => (
                                                <MenuItem key={name} value={name}>
                                                    <Checkbox checked={values.equipmentProvided.indexOf(name) > -1}/>
                                                    <ListItemText primary={name}/>
                                                </MenuItem>
                                            ))}
                                        </Field>
                ...
                <AppModal
                    title={"Lobby Created!"}
                    body={"You have successfully created a new lobby. Other campers can now see it and request to join."}
                    isOpen={isOpen}
                    onClose={handleClose}
                />
            </div>
